    ...
    switch (e.target.name) {
        case "usuario":
           if (expresiones.usuario.test(e.target.value)) {
            ...
            document.querySelector('#grupo_usuario > p').classList.remove('monstar_mensaje_error')
           } else { 
            ...
            document.querySelector('#grupo_usuario > p').classList.add('monstar_mensaje_error')
           }
            break;
        case "nombre":
            ...
            document.querySelector('#grupo_nombre > p').classList.remove('monstar_mensaje_error')  
            } else {
            ...
            document.querySelector('#grupo_nombre > p').classList.add('monstar_mensaje_error')
            }
            break;
            case "telefono":
            ...
            document.querySelector('#grupo_telefono > p').classList.remove('monstar_mensaje_error')  
                } else {
            ...
            document.querySelector('#grupo_telefono > p').classList.add('monstar_mensaje_error')
                }
            break;
